...
class EpgrabberGUI:
	def __init__(self):
		...
		self.episodesList.append_column(gtk.TreeViewColumn("Search",gtk.CellRendererText(),text=1))
		self.episodesList.append_column(gtk.TreeViewColumn("Series",gtk.CellRendererText(),text=2))
		self.episodesList.append_column(gtk.TreeViewColumn("Episode",gtk.CellRendererText(),text=3))
		self.episodesList.append_column(gtk.TreeViewColumn("Command",gtk.CellRendererText(),text=4))
